...
//Popup//
var popup_cards = document.getElementsByClassName("popup-card");
...
if (popup_cards != null && popupmenu != null) {
  var openPopup = function () {
    ...
    bodyElement.classList.add('disable-scrolling');
    show_overlay();
  };
...
//Career splide//
var cardHoverSliders = document.querySelectorAll(".splide_seven");
...
for (let i = 0; i < cardHoverSliders.length; i++) {
  ...
  new Splide(element, {
    ...
    breakpoints: {
      767: {
        perPage: 2, // Adjust perPage value for smaller screens
        type: "loop",
        autoplay: true,
        pauseOnHover: false,
        interval: 4000,
...
if (window.innerWidth <= 768) { 
  ...
  window.addEventListener("scroll", function () {
    ...
    if (typeof video !== 'undefined'  && scrollPosition >= pausePosition && !isVideoPaused) {
      video.pause();
      isVideoPaused = true; 
...
const expandendContainer = document.querySelectorAll('.expandContainer .expanded');
...
const draggableContent = document.querySelector(".dragContents, .client-testimonials-bg");
...
document.addEventListener("DOMContentLoaded", function () {    
  function bindPopupEvents() {
    ...
    function runPopupSlider() {    
      var stayInformedSlider = document.querySelector(".swiper-container");
      if (stayInformedSlider) {
        // var direction = 'vertical'; // Default direction
        
        // // Check if the screen width is less than 768 pixels
        // if (window.innerWidth < 768) {
        //   direction = 'horizontal'; // Change direction for mobile
        // }
...
$(document).ready(function() {
  ...
  $("#readMoreButton").click(function() {
    if (isHidden) {
      ...
      $(".grassroot-description p:not(:nth-child(-n+3))").hide();
      isHidden = true; 
    }
  });
});
